...
export class ProductsComponent implements OnInit {
	...
	getProducts() {
		this.codingService.getProducts().subscribe((res) => {
			this.products = res.body;
			this.orginProducts = res.body;
		});
	}
	...
	getPacking() {
		this.codingService.getPacking().subscribe((res) => {
	...
	onSearchChange(e: any) {
		...
		this.products = this.orginProducts.filter(
			(a: any) =>
				...
				a.category.name.toLowerCase().includes(str.toLowerCase()) ||
